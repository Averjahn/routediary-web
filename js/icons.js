...
const PATHS = {
  ...
  settings: `<circle ${S} cx="12" cy="12" r="3.2"/><path ${S} d="M19.4 15a1.6 1.6 0 0 0 .32 1.77l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.6 1.6 0 0 0-1.77-.32 1.6 1.6 0 0 0-.97 1.46V21a2 2 0 1 1-4 0v-.1a1.6 1.6 0 0 0-1.05-1.46 1.6 1.6 0 0 0-1.77.32l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.6 1.6 0 0 0 .32-1.77 1.6 1.6 0 0 0-1.46-.97H3a2 2 0 1 1 0-4h.1a1.6 1.6 0 0 0 1.46-1.05 1.6 1.6 0 0 0-.32-1.77l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.6 1.6 0 0 0 8.84 4.6 1.6 1.6 0 0 0 9.8 3.14V3a2 2 0 1 1 4 0v.1a1.6 1.6 0 0 0 .97 1.46 1.6 1.6 0 0 0 1.77-.32l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.6 1.6 0 0 0-.32 1.77V9.8a1.6 1.6 0 0 0 1.46.97H21a2 2 0 1 1 0 4h-.1a1.6 1.6 0 0 0-1.46.97Z"/>`,
  ...
  // Силуэт сбоку. Два правила, без которых иконка не читается:
  //   1. колесо должно быть заметно больше толщины обводки, иначе контур
  //      смыкается и кружок выглядит залитой точкой;
  //   2. линия днища прерывается там, где стоят колёса, — сплошная линия
  //      поверх колёс превращает рисунок в коробку на подставке.
  // Отдельная линия окон отделяет салон от кузова.
  car: `<path ${S} d="M2.4 15.6v-2.5a1.3 1.3 0 0 1 .4-.92l1.5-1.5a1.3 1.3 0 0 1 .55-.32l1.85-.53 1.9-2.4a1.9 1.9 0 0 1 1.5-.72h4.6a1.9 1.9 0 0 1 1.45.68l2.15 2.6 2.4.7a1.5 1.5 0 0 1 1.1 1.44v3.46"/><path ${S} d="M2.4 15.6h2.8M9.1 15.6h5.9M18.9 15.6h2.7"/><path ${S} d="M7.7 9.9h8.3"/><circle ${S} cx="7" cy="15.6" r="1.9"/><circle ${S} cx="16.9" cy="15.6" r="1.9"/>`,
  // Категории поездок
